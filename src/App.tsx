...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-blue-50 to-gray-100 dark:from-neutral-900 dark:via-gray-800 dark:to-neutral-900 text-gray-900 dark:text-gray-100 p-8 md:p-16 lg:px-32 relative overflow-hidden transition-colors">
